truncate table meta.A_RES;
insert into meta.a_res (RES_ID, RES_CODE, RES_NAME, RES_TYPE, RES_URL, RELATIVE, PARENT_ID, TREE_PATH, RES_ORDER, RES_ICON, AVAILABLE, VISIBLE, UPDATE_USER, UPDATE_TIME)
