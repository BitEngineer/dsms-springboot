------码表类型表
truncate table meta.A_CODETYPE;

insert into META.A_CODETYPE ( CODETYPE_ID, CODETYPE_CODE, CODETYPE_NAME, DESCRIPTION, ORDER_NO, SUPPORT_LEVEL, DELETE_FLAG,UPDATE_USER,UPDATE_TIME)
