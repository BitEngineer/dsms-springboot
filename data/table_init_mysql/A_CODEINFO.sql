...
truncate table A_CODEINFO;

insert into A_CODEINFO (CODEINFO_ID, CODEINFO_CODE, CODEINFO_VALUE, CODETYPE_ID, DESCRIPTION, ORDER_NO, ROOT_ID, PARENT_ID, CODE_LEVEL, TREE_PATH, VISIBLE, DELETE_FLAG, UPDATE_USER, UPDATE_TIME)
