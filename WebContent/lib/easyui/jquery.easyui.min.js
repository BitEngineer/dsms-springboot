...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,lines:false,animate:false,view:_8ec,rowEvents:$.extend({},$.fn.datagrid.defaults.rowEvents,{mouseover:_87d(true),mouseout:_87d(false),click:_87f}),loader:function(_929,_92a,_92b){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
...
$.fn.datalist.defaults=$.extend({},$.fn.datagrid.defaults,{fitColumns:true,showHeader:false,checkbox:false,lines:false,valueField:"value",textField:"text",groupField:"",view:_939,textFormatter:function(_955,row){
return _955;
...
$.extend(_a3e.calendar.calendar("options"),{border:false,onSelect:function(date){
